...
fprintf("Here numImages = %d", numImages);


%Begin altering script here 
%----------------------------------------------------------------------
%                        Condition Matrix
%----------------------------------------------------------------------
...
for trial = 1:numTrials
    ...
    imageNameA = imgList(trial);
    imageNameB = imgList(trial+1);
    
    % Now load the images
    myFileA = char(imageNameA);
        myFileB = char(imageNameB);

    
    theImageA = imread([imageFolder myFileA]);
    theImageB = imread([imageFolder myFileB]);
